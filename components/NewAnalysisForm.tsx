...
import { AnalysisRequest, TenderPlatform, TenderType } from '../types';
...
const NewAnalysisForm: React.FC<NewAnalysisFormProps> = ({ onStartAnalysis }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // The loading state will be set in the parent component, 
    // but we can show 'processing' on the button if a file was selected.
    if(lotFile && !isProcessingFile) setIsProcessingFile(true);
